...
const Modal = ({ applicantList, setApplicantList, companyBadges, currentIndex, setOpenModal }) => {
	...
	return (
		<div className="fixed inset-0 z-1" style={{ background: "rgba(0, 0, 0, 0.7)" }}>
			<div className="p-3 h-full max-w-screen-sm flex m-auto items-center">
				<div className="flex flex-col gap-3 rounded-md bg-white p-3 h-3/4">
					<Heading
						className="text-lg"
						{...{
					...
					<CardButtons className="flex h-10">
